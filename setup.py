...
name = 'Ourlogger',         # How you named your package folder (MyLib)
  ...
  url = 'https://github.com/peleg525/Ourlogger_p.git',   # Provide either the link to your github or to your website
  download_url = 'https://github.com/peleg525/Ourlogger_p/archive/refs/tags/V_01.tar.gz',    # I explain this later on
